...
@Service
public class CoverLetterScannerService {
    ...
    public CoverLetterScannerService(OptionalCustomUserToCustomUserService optionalCustomUserToCustomUserService,
    ...
    public String execute() throws IOException {
        ...
        if (user.getCoverLetter() != null) {
            PDDocument document = Loader.loadPDF(user.getCoverLetter());
            return pdfTextStripper.getText(document);
        }

        else {
            throw new ResumeMissingException(ExceptionMessages.COVER_LETTER_MISSING.getMessage());
        }
